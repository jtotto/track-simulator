...
void init_tracka(track_node *track) {
  ...
  track[82].coord_x = 1160;
  track[82].coord_y = 1600;
  ...
  track[83].coord_x = 1160;
  track[83].coord_y = 1600;
  track[84].name = "BR3";
